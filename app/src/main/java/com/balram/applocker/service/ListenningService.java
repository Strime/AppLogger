 ...
 */
public class ListenningService extends IntentService {
     ...
     */
    public ListenningService(String name) {
        super(name);
    }
    ...
    public void onCreate() {
        ...
        OpenHelperManager.setHelper(new SqlHelper(ListenningService.this));
        shouldCheckApp = true;
    ...
    private SqlHelper getHelper() {
        if(mHelper == null){
            mHelper = OpenHelperManager.getHelper(ListenningService.this, SqlHelper.class);
        }
        return mHelper;
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        switch ((ACTIONS) intent.getSerializableExtra(ListenningService.action)) {
            case STARTRECORDING:
    ...
    private final Runnable checkRunningApp = new Runnable(){
        ...
        public void run(){
            ...
            if(!currentApp.equals(IGNORE_TASK)) {
                ...
                Intent intent = new Intent(ListenningService.APPFIND);
                intent.putExtra(ListenningService.appname, currentApp);
